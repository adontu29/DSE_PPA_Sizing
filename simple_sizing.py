...
AIRCRAFT = {
    ...
    # Cruise/scissor permitted-CL cap. The wing-borne CLIMB instead derives its own
    # (tighter) CL limit from climb_stall_margin_n; see course_method_mission_energy.
...
def make_summary(result):
    ...
    return {
        ...
        # The scissor and every x_cg/MAC quantity use the geometric mean chord
        # (wing_chord_m = S/b) as the reference length; wing_mac_m below is the true
        # aerodynamic MAC of the tapered wing, reported for information only.
        "wing_mac_m": (
